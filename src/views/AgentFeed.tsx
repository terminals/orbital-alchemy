...
const AGENT_CHIP_CONFIG: Record<string, { emoji: string; label: string; color: string; activeColor: string; glowClass: string }> = {
  ...
  'funding-expert':    { emoji: '\u{1F4B0}', label: 'Funding', color: 'text-agent-funding', activeColor: 'bg-agent-funding/25 ring-1 ring-agent-funding/40', glowClass: 'glow-amber' },
  'trading-expert':    { emoji: '\u{1F4C8}', label: 'Trading', color: 'text-agent-trading', activeColor: 'bg-agent-trading/25 ring-1 ring-agent-trading/40', glowClass: 'glow-green' },
