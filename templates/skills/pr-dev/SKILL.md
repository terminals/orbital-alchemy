...
# /git pr-dev — Merge Feature Branch into Dev
...
- Feature branch has scope work committed via `/work save`
...
║                                                              ║
║  Next: /git pr-staging to create a PR from dev to staging    ║
╚═══════════════════════════════════════════════════════════════╝
```
...
- `/work save` — Commit work to feature branch (previous step)
- `/git pr-staging` — Create PR from dev to staging (next step)
