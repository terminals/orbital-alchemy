...
# /git pr-staging — GitHub PR from Dev to Staging
...
- Changes merged into dev (via `/git pr-dev`)
...
║                                                              ║
║  Next: Review PR, merge, then /git pr-production             ║
╚═══════════════════════════════════════════════════════════════╝
```
...
- `/git pr-dev` — Merge feature→dev (previous step)
- `/git pr-production` — Release PR staging→main (next step)
